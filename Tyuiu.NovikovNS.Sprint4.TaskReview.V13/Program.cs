...
using Tyuiu.NovikovNS.Sprint4.TaskReview.V13.Lib;
namespace Tyuiu.NovikovNS.Sprint4.TaskReview.V13
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Title = "Спринт #4 | Выполнил: Новиков Н.С. | ИСТНб-23-1";
